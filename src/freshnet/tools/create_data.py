...
def papple_data_prep(root_path, info_prefix, out_dir, split_dir, workers):
    """Prepare the info file for sunrgbd dataset.
    ...
    """
    indoor.create_indoor_info_file(
        root_path, pkl_prefix=info_prefix, save_path=out_dir, split_dir=split_dir, use_v1=False, workers=workers)
...
parser.add_argument(
    '--split-dir',
    type=str,
    default='papple_trainval',
    help='specify the dir of the dataset')

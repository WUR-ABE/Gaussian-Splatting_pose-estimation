...
class PappleDataset(Custom3DDataset):
    ...
    def get_data_info(self, index):
        ...
        if self.modality['use_camera']:
            ...
            #                    ]) @ rt_mat.transpose(1, 0)  # This makes the transformation matrix correct to get image features into 3D
    ...
    def get_ann_info(self, index):
        ...
        if info['annos']['gt_num'] != 0:
            ...
            gt_bboxes_3d = info['annos']['gt_boxes_upright_depth'].astype(
                np.float32)  # k, 6
            gt_bboxes_3d[:, 6:] *= 0.1  # Data scaling, as mentioned in data_utils (KITTI)
